    ...
    <main>
        ...
        <form action="actualizar_animal.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input name="descripcion_animal" value="<?php echo $fila2['Descripcion']?>" type="text" class="form-control" required>
            </div>
            <div class="mb-3">
                ...
                <select name="id_clasificacion" class="form-select" aria-label="Default select example">
                    ...
                    $consulta =" CALL p_tablaClasificacion()";
