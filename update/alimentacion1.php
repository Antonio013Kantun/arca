...
<body>
  ...
  <main>
        ...
        $consulta = "CALL p_obtenerAlimentacion($id_alimentacion)";
        ...
        <form action="actualizar_alimentacion.php" method="post">
            <div class="mb-3">
                ...
                <input name="nombre_alimentacion" value="<?php echo $fila['tipo_alimento']?>" type="text" class="form-control" required>
            </div>
